...
#ifndef MyAudiFXParams_H
#define MyAudiFXParams_H
...
{
    MyAudiFXParams();
    MyAudiFXParams(const MyAudiFXParams& in_rParams);
    ...
    MyAudiRTPCParams RTPC;
    MyAudiNonRTPCParams NonRTPC;
};

#endif // MyAudiFXParams_H
