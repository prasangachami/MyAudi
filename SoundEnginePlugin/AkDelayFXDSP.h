...
public:
	...
	CAkDelayFXDSP();
	~CAkDelayFXDSP();
	void Setup(MyAudiFXParams* pInitialParams, AkUInt32 in_uSampleRate);
	AKRESULT InitDelay(AK::IAkPluginMemAlloc* in_pAllocator, MyAudiFXParams* pParams, AkChannelConfig in_channelConfig);
	void ResetDelay();
...
private:
	...
	MyAudiFXParams				m_PreviousParams;			/// Cache previous parameters for parameter ramps
