...
void CAkDelayFXDSP::Setup(MyAudiFXParams* pInitialParams, AkUInt32 in_uSampleRate)
{
...
AKRESULT CAkDelayFXDSP::InitDelay(AK::IAkPluginMemAlloc* in_pAllocator, MyAudiFXParams* pParams, AkChannelConfig in_channelConfig)
{
